...
export class InicioSesionComponent implements OnInit {
  ...
  // Inicializa reCAPTCHA después de cargar el script
  ...
  // Renderiza el widget de reCAPTCHA
  ...
  // Login usuario por contraseña (modificado para incluir reCAPTCHA)
  onUserLogin(): void {
